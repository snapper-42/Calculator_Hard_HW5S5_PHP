...
<html>
    ...
    <head>
        ...
        <title> Homework 5 - Step 5: Interactive Dynamic Content - Hard </title>
    ...
    <body onload="Body_OnLoad();">
        ...
        Class: PHP <br />
        Abstract: Homework #5 - Step 5 - Interactive Dynamic Content - Hard <br />
        <br />
        <div class="BlackBar"> Homework#5 - Come to the Server Side </div>
        <br />

        <form name="frmSimpleCalculator" id="frmSimpleCalculator" action="Homework5Step5.php" method="get">
